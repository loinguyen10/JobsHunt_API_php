...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (
        ...
        if ($conn->query($sql1) === TRUE) {
            ...
            if($status == '00'){
                $sql_check = "SELECT * FROM `jh_user_profile` WHERE uid = '$userId'";
                ...
                $sql2 = "UPDATE jh_user_profile SET premium_expiry = FROM_UNIXTIME($expiry_time), level = 'Premium' WHERE uid = '$userId'";
